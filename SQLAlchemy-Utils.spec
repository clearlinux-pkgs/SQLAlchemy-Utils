...
Version  : 0.36.2
Release  : 48
URL      : https://files.pythonhosted.org/packages/40/77/425c1656c3bfbd68afd9d89175a8e0fcc0544cc828ba2a09974f12d36e67/SQLAlchemy-Utils-0.36.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/40/77/425c1656c3bfbd68afd9d89175a8e0fcc0544cc828ba2a09974f12d36e67/SQLAlchemy-Utils-0.36.2.tar.gz
...
%prep
%setup -q -n SQLAlchemy-Utils-0.36.2
cd %{_builddir}/SQLAlchemy-Utils-0.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584372594
...
cp %{_builddir}/SQLAlchemy-Utils-0.36.2/LICENSE %{buildroot}/usr/share/package-licenses/SQLAlchemy-Utils/03648fd95f199cb384e921cebbdc6b42ef07cb96
