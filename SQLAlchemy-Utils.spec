...
Source0  : https://files.pythonhosted.org/packages/fa/cd/cf58d3a95a619262f0f52eedc707d143b6ada636ed24f6765544c049fdf9/SQLAlchemy-Utils-0.33.8.tar.gz
...
%prep
%setup -q -n SQLAlchemy-Utils-0.33.8
...
export LANG=C
export SOURCE_DATE_EPOCH=1542639135
