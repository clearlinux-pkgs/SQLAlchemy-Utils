...
Version  : 0.36.7
Release  : 53
URL      : https://files.pythonhosted.org/packages/71/b2/84cda702d7253925f67212112838f3467907e7a0eeae1433a2b06db05e07/SQLAlchemy-Utils-0.36.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/71/b2/84cda702d7253925f67212112838f3467907e7a0eeae1433a2b06db05e07/SQLAlchemy-Utils-0.36.7.tar.gz
...
%prep
%setup -q -n SQLAlchemy-Utils-0.36.7
cd %{_builddir}/SQLAlchemy-Utils-0.36.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593713675
...
cp %{_builddir}/SQLAlchemy-Utils-0.36.7/LICENSE %{buildroot}/usr/share/package-licenses/SQLAlchemy-Utils/03648fd95f199cb384e921cebbdc6b42ef07cb96
