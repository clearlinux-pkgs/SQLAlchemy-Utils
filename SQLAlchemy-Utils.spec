...
Version  : 0.36.4
Release  : 50
URL      : https://files.pythonhosted.org/packages/00/f5/dca9de059b941f5063340b64596d0b89d7cbcbaed8acc2745cd446b1027b/SQLAlchemy-Utils-0.36.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/f5/dca9de059b941f5063340b64596d0b89d7cbcbaed8acc2745cd446b1027b/SQLAlchemy-Utils-0.36.4.tar.gz
...
%prep
%setup -q -n SQLAlchemy-Utils-0.36.4
cd %{_builddir}/SQLAlchemy-Utils-0.36.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588306844
...
cp %{_builddir}/SQLAlchemy-Utils-0.36.4/LICENSE %{buildroot}/usr/share/package-licenses/SQLAlchemy-Utils/03648fd95f199cb384e921cebbdc6b42ef07cb96
