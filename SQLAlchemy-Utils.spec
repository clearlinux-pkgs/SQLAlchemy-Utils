...
Version  : 0.36.8
Release  : 54
URL      : https://files.pythonhosted.org/packages/14/68/e5301c4c960c79a32333b8805e52cb69d3d237aa869a773b4157ccb3eb26/SQLAlchemy-Utils-0.36.8.tar.gz
...
%prep
%setup -q -n SQLAlchemy-Utils-0.36.8
cd %{_builddir}/SQLAlchemy-Utils-0.36.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594223047
...
cp %{_builddir}/SQLAlchemy-Utils-0.36.8/LICENSE %{buildroot}/usr/share/package-licenses/SQLAlchemy-Utils/03648fd95f199cb384e921cebbdc6b42ef07cb96
